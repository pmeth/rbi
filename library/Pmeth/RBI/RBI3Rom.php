...
class RBI3Rom extends Rom {
   ...
   protected $playerSize;
   protected $hittersPerTeam;
   protected $pitchersPerTeam;
   ...
   function __construct($filename) {
      ...
      $this->hittersPerTeam = 14;
      $this->pitchersPerTeam = 10;
   ...
   public function getHittersPerTeam() {
      return $this->hittersPerTeam;
   }

   public function getPitchersPerTeam() {
      return $this->pitchersPerTeam;
   }

   public function getPlayersPerTeam() {
      return $this->hittersPerTeam + $this->pitchersPerTeam;
   }
